...
{
     public class AtlasBaseAnonimousController<TBaseEntity> : AtlasBaseJsonAnonimousController<TBaseEntity> where TBaseEntity : BaseEntity
    {
        private readonly string _resourceName;
        public AtlasBaseAnonimousController(IBaseService<TBaseEntity> baseService) : base(baseService)
        {
