...
{
    public class AtlasMixedBaseAnonimousController<TBaseEntity, TBaseDtoRequest, TBaseDtoResponse> : AtlasMixedJsonBaseAnonimousController<TBaseEntity, TBaseDtoRequest, TBaseDtoResponse>
    ...
    where TBaseDtoResponse: AtlasBaseDto
    {
        ...
        public AtlasMixedBaseAnonimousController(IAtlasBaseServiceMixed<TBaseEntity, TBaseDtoRequest, TBaseDtoResponse> baseService, string? resourceName =null) : base(baseService, resourceName)
        {
        }
