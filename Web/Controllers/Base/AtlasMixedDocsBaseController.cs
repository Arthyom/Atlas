...
{
    public class AtlasMixedDocsBaseController<TBaseEntity, TBaseDtoRequest, TBaseDtoResponse> :
    ...
    {
        public AtlasMixedDocsBaseController(IAtlasBaseServiceMixed<TBaseEntity, TBaseDtoRequest, TBaseDtoResponse> baseService, string? resourceName = null) : base(baseService, resourceName)
        {
        }
