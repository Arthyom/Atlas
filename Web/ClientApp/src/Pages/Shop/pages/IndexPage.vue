      ...
      > -->
        <div class="card bg-base-100  shadow-sm my-15">
          <div class="card-body m-1 p-1">
            ...
            <h2 class="text-3xl font-bold text-center m-0 p-0">
              CapOs
            </h2>
          </div>
          <figure>
        ...
        <div class="my-20">
          <h1 class="font-extralight text-4xl mb-2">Los Más Vendidos</h1>
          <swiper
            :slides-per-view="2"
            :space-between="10"
            @swiper="onSwiper"
          ...
          >
            <swiper-slide v-for="producto in props.mainResourceCollection" :key="producto.id">
        ...
        <div>
          <h1 class="font-extralight text-4xl mb-2 ">Nuestro Catalogo</h1>
          <div class="my-2 p-1 "
